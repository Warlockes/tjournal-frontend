...
// 8) Приверить, какие поля возвращаются с бэка, шифровать пароль
// bug: Проработать этап регистрации. Закрывать окно регистрации. Токен при регистрации пишется в куки, потом при перезагрузке страницы проиходит сразу логин - так не должно быть\
// 9) FullPost - настроить рендер для EditorJS для блоков разных типов
// 10) Сделать скелетоны для комментариев, да и в целом для загрузок
